...
----------------------------------------------------
1. Download or clone repository to local machine. If the location of the project folder is on any cloud storage backup service like Dropbox or One Drive, switch off the syncing to prevent any issues with the package installation process.
